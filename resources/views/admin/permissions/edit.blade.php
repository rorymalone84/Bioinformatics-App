<x-app-layout>
    ...
    <x-page.section heading="Edit existing Permission">
        ...
        <form method="POST" action="{{ route('admin.permissions.update', $permission) }}">
          ...
          <div class="sm:col-span-6">
            ...
            <div class="mt-1">
              <input type="text" id="name" name="name" value="{{$permission->name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
            </div>
