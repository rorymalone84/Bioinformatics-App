                ...
                <tr>
                    ...
                    <td class="px-6 py-4 flex justify-end">
                        <div class="flex">
                            ...
                            <x-page.link-button href="{{route('admin.permissions.destroy', $permission->id)}}" class="bg-red-600 text-blue-100 dark:bg-red-700 dark:text-grey-100">Delete</x-page.link-button>                    
                        </div>
                    </td>
                </tr>
                @endforeach
