<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-end">
            <x-page.link-button href="#" class="bg-green-400 dark:bg-green-700">Create Role</x-page.link-button>
        </div>        
    </x-slot>
        ...
        <div class="overflow-x-auto w-full">            
            <x-table.table :headers="['Role','Edit','Delete']">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-center">
                        <div class="flex items-center space-x-3">
                            <x-page.link-button href="/dashboard">Delete</x-page.link-button>
                        </div>
                    </td>
                </tr>
                @endforeach
